...
#define CMD_CDSF                0x46534443   // CDS Frequency (as a fraction of MODF)
#define CMD_ADFS                0x53464441   // ADC Sampling Frequency
#define CMD_LOGS                0x53474f4c   // Log2 samples per ADC block
#define CMD_SETT                0x54544553   // Modulator settling time in us
#define CMD_DBAN                0x4e414244   // DAC Update deadband in nV
#define CMD_DTIM                0x4d495444   // Modulator deadtime in us
#define CMD_DTID                0x44495444   // Demodulator deadtime in us
#define CMD_SINC                0x434e4953   // Sinc filter order (1 - 3)

#define CMD_DACA                0x41434144   // DAC Channel A code (MOD1 HIGH LEVEL)
#define CMD_DACB                0x42434144   // DAC Channel B code (VOS COMP)
#define CMD_DACC                0x43434144   // DAC Channel C code (MOD2 HIGH LEVEL)
#define CMD_DACD                0x44434144   // DAC Channel D code (MOD LOW LEVEL)
#define CMD_DACE                0x45434144   // Internal (DEMOD) DAC code (12 bit)

#define CMD_MOD                 0x00444f4d   // Modulator
#define CMD_CDS                 0x00534443   // CDS
#define CMD_GAIN                0x4e494147

#define CMD_INP                 0x00504e49
#define CMD_RELA                0x414c4552

#define CMD_CAP                 0x00504143
#define CMD_RES                 0x00534552
#define CMD_SET                 0x00544553
#define CMD_RESE                0x45534552

#define CMD_ON                  0x00004e4f
#define CMD_OFF                 0x0046464f

extern AcqParam_t acq1;
